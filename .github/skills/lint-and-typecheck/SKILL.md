...
description: Use when the user asks to check code quality, lint the codebase, verify types, or ensure code meets project standards. Also use after making changes to catch type errors and style violations early.
---
